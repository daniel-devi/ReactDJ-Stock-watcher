...
SECRET_KEY = 'django-insecure-ttk+#kwa7+^bfs)m5g&+csll&mi6sd-l^=tbp%i@&b&7c@g^(b'
...
INSTALLED_APPS = [
    # Jazzmin - Has to be placed before Django Admin Apps
    'jazzmin',
    # Django Apps
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to Stocker",
    "copyright": "Stocker",
